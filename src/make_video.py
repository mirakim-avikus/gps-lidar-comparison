...
def create_video_from_images(image_path, output_video_path, frame_rate=30):
    """
...
if __name__ == "__main__":
    ...
    image_path = f"{root_path}/testset/{own_tgt}_{case_name}/camera"
    video_result_path = f"{root_path}/result/{own_tgt}_{case_name}/video.mp4"
    frame_rate = 30  # Frame rate of the output video

    create_video_from_images(image_path, video_result_path, frame_rate)
